...
func (bc *BlockChain) HasBlock(hash meta.BlockID) bool {
	if bc.blockCache.Contains(hash) {
		return true
	}
...
func (bc *BlockChain) GetBlockByID(hash meta.BlockID) (*meta.Block, error) {
...
func (bc *BlockChain) GetBlockByHeight(height uint32) (*meta.Block, error) {
...
func (bc *BlockChain) GetBestBlock() *meta.Block {
	return bc.CurrentBlock()
}

func (bc *BlockChain) CheckBlock(block *meta.Block) error {
