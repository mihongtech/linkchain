...
func (*HashNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_trie_866f538233307a9b, []int{0}
}
...
func (*ValueNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_trie_866f538233307a9b, []int{1}
}
...
func (*FullNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_trie_866f538233307a9b, []int{2}
}
...
func (*ShortNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_trie_866f538233307a9b, []int{3}
}
...
func init() { proto.RegisterFile("protobuf/trie.proto", fileDescriptor_trie_866f538233307a9b) }

var fileDescriptor_trie_866f538233307a9b = []byte{
