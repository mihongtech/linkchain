...
func (s *Spec) NewMsg(code uint64) (proto.Message, bool) {
	s.init()
	_, ok := s.types[code]
	if !ok {
		return nil, false
...
func (p *Peer) Handshake(ctx context.Context, hs proto.Message, verify func(interface{}) error) (rhs interface{}, err error) {
